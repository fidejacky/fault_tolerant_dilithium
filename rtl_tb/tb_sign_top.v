...
module tb_sign_top;
  ...
  initial begin
    ...
    $readmemh("C:/Jacky/bachely_jacky/KAT/zs_3.txt",   z_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/h_3.txt",    h_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/c_3.txt",    c_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/rho_3.txt",  rho_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/k_3.txt",    k_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/tr_3.txt",   tr_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/t0_3.txt",   t0_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/s1_3.txt",   s1_3);
    $readmemh("C:/Jacky/bachely_jacky/KAT/s2_3.txt",   s2_3);

    $readmemh("C:/Jacky/bachely_jacky/KAT/zs_5.txt",   z_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/h_5.txt",    h_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/c_5.txt",    c_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/rho_5.txt",  rho_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/k_5.txt",    k_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/tr_5.txt",   tr_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/t0_5.txt",   t0_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/s1_5.txt",   s1_5);
    $readmemh("C:/Jacky/bachely_jacky/KAT/s2_5.txt",   s2_5);
  ...
  always @(posedge clk) begin
    if (!tb_enable) begin
        // Hold everything inactive
        data_i  <= 0;
        valid_i <= 0;
        ready_o <= 0;
        start   <= 0;
        rst     <= 1;   // keep DUT in reset
    end
    else begin
        // Normal stimulus behavior
        rst     <= 0;
        data_i  <= 0;
        valid_i <= 0;
        ready_o <= 0;
